...
export const projects: Project[] = [
  ...
  },
  {
    ...
    name: "Agenda Tu Cita",
    category: ["all", "react"],
    image: "/images/projects/agenda_tu_cita.gif",
    gif: "/images/projects/agenda_tu_cita.gif",
    description: {
      en: "All opticians in the country in one website",
      es: "Todas las ópticas del país en un solo sitio web",
    },
    tech: ["React", "Node.js", "MongoDB"],
    github: "",
    demo: "https://www.agendatucitavisual.com/",
  },
  {
    id: "21",
    name: "Ambit",
    category: ["all", "react"],
    image: "/images/projects/ambit.gif",
    gif: "/images/projects/ambit.gif",
    description: {
      en: "Website for employees, learning guide and work tool",
      es: "Sitio web para empleados, guía de aprendizaje y herramienta de trabajo",
    },
    tech: ["React", "TypeScript"],
    github: "",
    demo: "https://soft-tartufo-3fe8cf.netlify.app/learnerguide/ambitenergy",
  },
  {
    id: "22",
    name: "Carlos Portfolio",
    category: ["all", "react"],
    image: "/images/projects/carlos.gif",
    gif: "/images/projects/carlos.gif",
    description: {
      en: "Personal portfolio website for a professional teacher",
      es: "Sitio web de portafolio personal para un docente profesional",
    },
    tech: ["React", "Gatsby", "CSS"],
    github: "",
    demo: "https://www.cfuentes.com/",
  },
  {
    id: "23",
    name: "CriptoSabia",
    category: ["all", "react"],
    image: "/images/projects/criptosabia.gif",
    gif: "/images/projects/criptosabia.gif",
    description: {
      en: "Platform focused on managing investments in digital assets and cryptocurrencies",
      es: "Plataforma enfocada en la gestión de inversiones en activos digitales y criptomonedas",
    },
    tech: ["React", "Redux", "WebSocket"],
    github: "",
    demo: "https://dreamy-rugelach-0ccd07.netlify.app/",
  },
  {
    id: "24",
    name: "Customer Solutions",
    category: ["all", "react"],
    image: "/images/projects/customers_solutions.gif",
    gif: "/images/projects/customers_solutions.gif",
    description: {
      en: "Consulting and technology services company focused on improving the customer experience",
      es: "Consultoría y servicios tecnológicos enfocada en mejorar la experiencia del cliente",
    },
    tech: ["React", "Node.js", "PostgreSQL"],
    github: "",
    demo: "https://www.customerssol.com/",
  },
  {
    id: "25",
    name: "Paqari",
    category: ["all", "react"],
    image: "/images/projects/paqari.gif",
    gif: "/images/projects/paqari.gif",
    description: {
      en: "Inventory software that organizes your business",
      es: "El software de inventario que organiza todo tu negocio",
    },
    tech: ["React", "Next.js", "Stripe"],
    github: "",
    demo: "https://paqari.pe/",
  },
  {
    id: "26",
    name: "Portal Clientes",
    category: ["all", "react"],
    image: "/images/projects/portal_clientes.gif",
    gif: "/images/projects/portal_clientes.gif",
    description: {
      en: "Customer self-service portal for managing accounts and services",
      es: "Portal de autoservicio para clientes para gestionar cuentas y servicios",
    },
    tech: ["React", "TypeScript", "Nextjs"],
    github: "",
    demo: "https://portalsoftix.site/login",
  },
  {
    id: "27",
    name: "Sabia",
    category: ["all", "react"],
    image: "/images/projects/sabia.gif",
    gif: "/images/projects/sabia.gif",
    description: {
      en: "Knowledge management platform for finance education",
      es: "Plataforma de gestión del conocimiento para educación financiera",
    },
    tech: ["React", "Node.js", "Elasticsearch"],
    github: "",
    demo: "https://sabiasyf.com/",
  },
  {
    id: "28",
    name: "Softix",
    category: ["all", "react"],
    image: "/images/projects/softix.gif",
    gif: "/images/projects/softix.gif",
    description: {
      en: "Software company website with service catalog and project portfolio",
      es: "Sitio web de empresa de software con catálogo de servicios y portafolio de proyectos",
    },
    tech: ["React", "Next.js", ".Net"],
    github: "",
    demo: "https://portalsoftix.site/",
  },
  {
    id: "29",
    name: "Sukabet",
    category: ["all", "javascript"],
    image: "/images/projects/sukabet.gif",
    gif: "/images/projects/sukabet.gif",
    description: {
      en: "Betting platform with live odds and real-time updates",
      es: "Plataforma de apuestas con odds en vivo y actualizaciones en tiempo real",
    },
    tech: ["JavaScript", "React", "WebSocket"],
    github: "",
    demo: "https://sukabet.us/",
  },
  {
    id: "30",
    name: "Tu Óptica",
    category: ["all", "react"],
    image: "/images/projects/tu_optica.gif",
    gif: "/images/projects/tu_optica.gif",
    description: {
      en: "Custom E-commerce for optical products with virtual try-on feature",
      es: "E-commerce personalizado de productos ópticos para ópticas",
    },
    tech: ["React", ".NET", "Next.js"],
    github: "",
    demo: "https://tuoptica.online/paravivir",
  },
].reverse();
